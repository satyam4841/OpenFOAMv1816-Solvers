...
Welding: Contains Solver related to welding process
	...
	finalv2: Welding solver
		Details: Convective heat transfer boundary condition. Only conductive heat transfer is accounted. Involves phase change. Can simulate any welding 			path coordinates read .txt path file. 'Oct10_2.txt' is path file containing coordinates of spiral.
